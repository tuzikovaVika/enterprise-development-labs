    ...
    where TKey : struct
{
    ...
    /// <returns>Созданная сущность в виде Dto</returns>
    Task<TDto> Create(TCreateUpdateDto newDto);
    ...
    /// <returns>Обновленная сущность в виде Dto</returns>
    Task<TDto> Update(TKey key, TCreateUpdateDto newDto);

    /// <summary>
    ///     Удаление сущности (например, удаление рейса, клиента или бронирования)
    /// </summary>
    /// <param name="id">Идентификатор сущности</param>
    /// <returns>Удаленная сущность в виде Dto</returns>
